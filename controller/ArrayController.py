...
from model.Product import Product as Producto
...
class ShoppingListController:
  ...
  def create_shopping_list(self):
    nombre = input("\nNombre de tu lista: ")
    shop_list = ShoppingArray(nombre, self.user.username)
  ...
  def delete_product(self, shopping_list):
    id_producto_a_eliminar = int(input("Ingrese el id del producto que desea eliminar: "))
    shopping_list.eliminar_producto(id_producto_a_eliminar)
    shopping_list.guardar_productos_json()

  def update_product(self,shopping_list):
    id_producto_a_modificar = int(input("Ingrese el id del producto que desea modificar: "))
    shopping_list.modificar_producto(id_producto_a_modificar)
    print(f"El producto con el id {id_producto_a_modificar} ha sido modificado")
    shopping_list.guardar_productos_json()

  def mark_purchased(self, shopping_list):
    nombre_producto = input("Ingrese el nombre del producto a marcar como comprado: ")
    shopping_list.marcar_comprado(nombre_producto)
    print(f"{nombre_producto} se tacho de la lista")
    print("")
  ...
  def find_product(self, shopping_list):
    id_nombre_producto = int(input("Ingrese el id del producto que quieres buscar: "))
    print("")
    shopping_list.buscar_producto(id_nombre_producto)
            ...
            with open('resources/listas_compras.csv', newline='') as file:
                ...
                for row in reader:
                    ...
                    if username == self.user.username:
                        new_list = ShoppingArray(name, self.user.username)
